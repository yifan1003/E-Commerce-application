...
def change_password(request):
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            # current_password is hashed, we must check if the user put current_password match we have in database
            # we use django inbuilt method to check
...
def order_detail(request, order_id):
    ...
    for o in order_detail:
        subtotal += o.product_price * o.quantity
    context = {
